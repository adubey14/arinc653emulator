...
public:
		...
		{}
		virtual bool IsInternalEventSet(){ return false;} // Checks if there are any internal events set
		virtual void GetOutputEvents(set<Event>& events){events.clear();} // Gets the list of Output Events generated 
		...
		virtual void performTransitionAction(TRANSID tid){} // Execute transaction -action
