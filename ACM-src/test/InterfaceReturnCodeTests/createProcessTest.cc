...
void PROCESS_CORRECT (void){
	...
	CREATE_PROCESS(&PROCESS_INVALID_MODE_ATTR,&PROCESS_INVALID_MODE_ID,&RETURN_CODE);
...
void correctProcessTest(void){
	...
	PROCESS_CORRECT_ATTR.STACK_SIZE=0; //We currently do not support restricting stack size in this emulator
...
void redundantProcessTest(void){
	...
	//create the process REDUNDANT process with the name of a process that already exists
	...
	PROCESS_REDUNDANT_ATTR.STACK_SIZE=0; //We currently do not support restricting stack size in this emulator
	...
	CREATE_PROCESS(&PROCESS_REDUNDANT_ATTR,&PROCESS_REDUNDANT_ID,&RETURN_CODE); //Attempts to create the process again
...
void invalidPriorityProcessTest(void){
	...
	PROCESS_BAD_PRIORITY_ATTR.ENTRY_POINT=(SYSTEM_ADDRESS_TYPE)PROCESS_BAD_PRIORITY;
	PROCESS_BAD_PRIORITY_ATTR.STACK_SIZE=0; //We currently do not support restricting stack size in this emulator
	strncpy(PROCESS_BAD_PRIORITY_ATTR.NAME,PROCESS_BAD_PRIORITY_NAME,MAX_NAME_LENGTH);
	CREATE_PROCESS(&PROCESS_BAD_PRIORITY_ATTR,&PROCESS_BAD_PRIORITY_ID,&RETURN_CODE);
...
//	PROCESS_BAD_PERIOD_ATTR.STACK_SIZE=0; //We currently do not support restricting stack size in this emulator
...
void invalidTimeCapacityProcessTest(void){
	...
	PROCESS_NAME_TYPE PROCESS_BAD_TIME_CAPACITY_NAME="PROCESS_BAD_TIME_CAPACITY";
	...
	PROCESS_BAD_TIME_CAPACITY_ATTR.ENTRY_POINT=(SYSTEM_ADDRESS_TYPE)PROCESS_BAD_TIME_CAPACITY;
	PROCESS_BAD_TIME_CAPACITY_ATTR.STACK_SIZE=0; //We currently do not support restricting stack size in this emulator
	strncpy(PROCESS_BAD_TIME_CAPACITY_ATTR.NAME,PROCESS_BAD_TIME_CAPACITY_NAME,MAX_NAME_LENGTH);
	CREATE_PROCESS(&PROCESS_BAD_TIME_CAPACITY_ATTR,&PROCESS_BAD_TIME_CAPACITY_ID,&RETURN_CODE);
	if(RETURN_CODE == INVALID_PARAM) {
...
void capacityGreaterThanPeriodTest(void){
	...
	PROCESS_NAME_TYPE PROCESS_CAPACITY_GREATER_THAN_PERIOD_NAME="PROCESS_CAPACITY_GREATER_THAN_PERIOD";

	//create the process CAPACITY_GREATER_THAN_PERIOD process with capacity greater than the period
	...
	PROCESS_CAPACITY_GREATER_THAN_PERIOD_ATTR.TIME_CAPACITY=convertSecsToNano(6);
	PROCESS_CAPACITY_GREATER_THAN_PERIOD_ATTR.DEADLINE=HARD;
	PROCESS_CAPACITY_GREATER_THAN_PERIOD_ATTR.ENTRY_POINT=(SYSTEM_ADDRESS_TYPE)PROCESS_CAPACITY_GREATER_THAN_PERIOD;
	PROCESS_CAPACITY_GREATER_THAN_PERIOD_ATTR.STACK_SIZE=0; //We currently do not support restricting stack size in this emulator
	strncpy(PROCESS_CAPACITY_GREATER_THAN_PERIOD_ATTR.NAME,PROCESS_CAPACITY_GREATER_THAN_PERIOD_NAME,MAX_NAME_LENGTH);
	CREATE_PROCESS(&PROCESS_CAPACITY_GREATER_THAN_PERIOD_ATTR,&PROCESS_CAPACITY_GREATER_THAN_PERIOD_ID,&RETURN_CODE);
	if(RETURN_CODE == INVALID_PARAM) {
...
PROCESS_INVALID_MODE_ATTR.ENTRY_POINT=(SYSTEM_ADDRESS_TYPE)PROCESS_INVALID_MODE;
PROCESS_INVALID_MODE_ATTR.STACK_SIZE=0; //We currently do not support restricting stack size in this emulator
strncpy(PROCESS_INVALID_MODE_ATTR.NAME,PROCESS_INVALID_MODE_NAME,MAX_NAME_LENGTH);
