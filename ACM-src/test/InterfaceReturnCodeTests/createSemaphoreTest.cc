...
int main (){
	...
	//Tests that the correct code is returned when attempting to create a semaphore with  the name of an existing semaphore
	...
	//Tests that the correct code is returned when the given current value is greater than the given max value
	...
	//Tests that the correct code is returned when the given maximum value is out of range
	...
	//Tests that the correct code is returned when an invalid queuing discipline is given
