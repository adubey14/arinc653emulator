...
namespace ACM_INTERNAL{
	...
	APEX_BUFFER_TYPE::APEX_BUFFER_TYPE(BUFFER_NAME_TYPE NAME,BUFFER_ID_TYPE ID,MESSAGE_SIZE_TYPE size, MESSAGE_RANGE_TYPE MAX_NB_MESSAGE):  
		BUFFER_NAME(NAME),
		BUFFER_ID(ID),
		BUFFER_MAX_MESSAGE_SIZE(size),
		BUFFER_MAX_NB_MESSAGE(MAX_NB_MESSAGE),
		CURRENT_MESSAGE_SIZE(0),
		BUFFER_HEAD(0),
		BUFFER_TAIL(0),
		PAYLOAD(0),
		BUFFER_READ_SEMAPHORE((ACM_USER::SEMAPHORE_VALUE_TYPE)0,(ACM_USER::SEMAPHORE_VALUE_TYPE)MAX_NB_MESSAGE),
		BUFFER_WRITE_SEMAPHORE((ACM_USER::SEMAPHORE_VALUE_TYPE)MAX_NB_MESSAGE,(ACM_USER::SEMAPHORE_VALUE_TYPE)MAX_NB_MESSAGE),
		BUFFER_MUTEX()
	{
		//Buffer has been created. it will be initialized now.
		PAYLOAD= (PAYLOAD_TYPE*) malloc(sizeof(PAYLOAD_TYPE)*BUFFER_MAX_NB_MESSAGE);
	...
	void APEX_BUFFER_TYPE::RECEIVE_MESSAGE(/*in */ SYSTEM_TIME_TYPE TIME_OUT, /*out*/ MESSAGE_ADDR_TYPE MESSAGE_ADDR,	/*out*/ MESSAGE_SIZE_TYPE *LENGTH,/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
	...
	void APEX_BUFFER_TYPE::SEND_MESSAGE (/*in */ MESSAGE_ADDR_TYPE MESSAGE_ADDR, /* by reference */	/*in */ MESSAGE_SIZE_TYPE LENGTH,/*in */ SYSTEM_TIME_TYPE TIME_OUT,/*out*/ RETURN_CODE_TYPE *RETURN_CODE) 
	{
	...
	void APEX_BUFFER_TYPE::GET_BUFFER_STATUS (/*out*/ BUFFER_STATUS_TYPE *BUFFER_STATUS,	/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		...
		BUFFER_STATUS->WAITING_PROCESSES = BUFFER_READ_SEMAPHORE.GET_WAITING_COUNT() + BUFFER_WRITE_SEMAPHORE.GET_WAITING_COUNT();
		*RETURN_CODE=NO_ERROR;
	}
