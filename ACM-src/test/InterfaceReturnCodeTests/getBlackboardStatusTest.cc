...
void PROCESS_APERIODIC (void){
	...
	//Tests that no error is returned when correctly getting a blackboard's status
	...
	//Tests that the correct code is returned when attempting to get the status of a nonexistent blackboard
