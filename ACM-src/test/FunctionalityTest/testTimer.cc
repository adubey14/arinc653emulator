/*
This file tests the use of ACM timer interface, which implements a discrete event scheduler.
...
int main(){
	...
	try{
		...
		APERIODIC_PROCESS_ID_1 = APEX_HELPER_CREATE_PROCESS(INFINITE_TIME_VALUE, //SYSTEM_TIME_TYPE PERIOD,
