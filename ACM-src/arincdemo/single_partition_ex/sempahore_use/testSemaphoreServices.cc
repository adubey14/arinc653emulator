...
void PROCESS_PERIODIC_1 (void)
{
	...
	SEMAPHORE_STATUS_TYPE sem_status;
		...
		LOGGER(USER,"PROCESS_PERIODIC_1: SEM current value %ld, waiting processes: %ld", sem_status.CURRENT_VALUE,sem_status.WAITING_PROCESSES);
...
PROCESS_PERIODIC_ATTR_2.STACK_SIZE=0; //We currently do not support restricting stack size in this emulator
strncpy(PROCESS_PERIODIC_ATTR_2.NAME,PROCESS_PERIODIC_NAME_2,MAX_NAME_LENGTH);
CREATE_PROCESS(&PROCESS_PERIODIC_ATTR_2,&PROCESS_PERIODIC_ID_2,	&RETURN_CODE);
ACM_ASSERT(RETURN_CODE==NO_ERROR);
