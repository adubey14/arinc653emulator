...
int main (){
	...
	PROCESS_APERIODIC_ATTR2.STACK_SIZE=0; //We currently do not support restricting stack size in this emulator
	strncpy(PROCESS_APERIODIC_ATTR2.NAME,PROCESS_APERIODIC_NAME2,MAX_NAME_LENGTH);
	CREATE_PROCESS(&PROCESS_APERIODIC_ATTR2,&PROCESS_APERIODIC_ID2,	&RETURN_CODE);
