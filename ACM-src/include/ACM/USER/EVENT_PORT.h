...
public:
  void ADD_INTER_MODULE_DESTINATION_URL(NAME_TYPE nodename,
                                        unsigned int port_number,
                                        RETURN_CODE_TYPE *RETURN_CODE);
  void ADD_INTER_MODULE_SOURCE_SOCKET(unsigned int port_number,
                                      RETURN_CODE_TYPE *RETURN_CODE);

  ACM_EVENT_PORT(EVENT_PORT_COMM_TYPE COMM_TYPE, EVENT_PORT_NAME_TYPE NAME,
                 MESSAGE_SIZE_TYPE SIZE, SYSTEM_TIME_TYPE VALIDITY_PERIOD,
  ...
  void
  BLOCK_AND_TRANSFER_FROM_SOCKET_READ_PORT(RETURN_CODE_TYPE *RETURN_CODE,
                                           SYSTEM_TIME_TYPE PORT_TIME_OUT = 0);
  ...
  void READ_FROM_EVENT_PORT(MESSAGE_ADDR_TYPE MESSAGE_ADDR,
                            MESSAGE_SIZE_TYPE *LENGTH, bool *IS_VALID,
...
private:
  void PARSE_AND_VALIDATE_DATA(MESSAGE_ADDR_TYPE MESSAGE_ADDR,
                               ...
                               VALIDITY_TYPE VALIDITY, bool *IS_VALID,
                               RETURN_CODE_TYPE *RETURN_CODE);

  bool ASSEMBLE_DATA(MESSAGE_ADDR_TYPE MESSAGE_ADDR, MESSAGE_SIZE_TYPE LENGTH,
