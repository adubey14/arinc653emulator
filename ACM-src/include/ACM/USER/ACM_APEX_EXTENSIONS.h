...
namespace ACM_USER {
//! \name HELPER FUNCTIONS (Not Part of APEX Specifications). These are added functions which are not part of the regular APEX library. They are implemented as a combination of one or more than one standard ARINC function calls.
	//@{
	/* ! 
	* 
	*/
	...
	*/
	...
	PROCESS_ID_TYPE APEX_HELPER_CREATE_PROCESS(/*!in*/SYSTEM_TIME_TYPE PERIOD, /*!in*/SYSTEM_TIME_TYPE TIME_CAPACITY, /*!in*/SYSTEM_ADDRESS_TYPE ENTRY_POINT, /*!in*/STACK_SIZE_TYPE STACK_SIZE, /*!in*/PRIORITY_TYPE BASE_PRIORITY, /*!in*/DEADLINE_TYPE DEADLINE,/*!in*/std::string PROCESS_NAME,/*!out*/RETURN_CODE_TYPE *RETURN_CODE);
	...
	//!Will create and start a dummy process. Such processes are necessary for process suspension.
...
//! \name PROCESS MANAGEMENT EXTENSIONS (Not Part of APEX Specifications). These are added functions which are not part of the regular APEX library. They are implemented as a combination of one or more than one standard ARINC function calls.
	//@{
	/* ! 
	* 
	*/
	...
	void GET_PROCESS_FINISHED_STATUS(
			...
			//! \name HM Services. Health Manager Extensions. (Not Part of APEX Specifications). They are implemented as a combination of one or more than one standard ARINC function calls. This Health Management is different than typical ARINC Error Handling Services.
			

	void CREATE_HEALTH_MANAGER_PROCESS(/*!in*/SYSTEM_ADDRESS_TYPE ENTRY_POINT,
	...
	void RAISE_APPLICATION_ERROR_AND_GET_RESPONSE (	/*!in */ ERROR_CODE_TYPE ERROR_CODE,
	...
	//void RAISE_APPLICATION_ERROR_AND_GET_RESPONSE (	 ERROR_CODE_TYPE ERROR_CODE,
	...
	//	SYSTEM_TIME_TYPE TIME_OUT, //Added Timeout in response to the discussion with Gabor
	...
	//!\name RW_LOCK_SEMAPHORE management services (Not Part of APEX Specifications).
