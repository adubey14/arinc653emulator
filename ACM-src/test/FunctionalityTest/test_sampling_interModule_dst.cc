/* This program tests the intermodule sampling channel used by the network partition. use it with test_sampling_interModule_src */
...
SAMPLING_CHANNEL channel(std::string("testChannel2"),INTER_MODULE_DST,2314);
...
while(true)
{
	...
	std::cout<<"Last Message Validity"<<SAMPLING_PORT_STATUS.LAST_MSG_VALIDITY<<std::endl;
}
return 0;
} // End of Try
