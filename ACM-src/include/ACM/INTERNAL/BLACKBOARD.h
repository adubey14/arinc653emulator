...
namespace ACM_INTERNAL{
	...
	public:
		...
		APEX_BLACKBOARD_TYPE(BLACKBOARD_NAME_TYPE NAME,BLACKBOARD_ID_TYPE ID,MESSAGE_SIZE_TYPE size);

		void ERASE_BLACKBOARD(RETURN_CODE_TYPE *RETURN_CODE);

		void WRITE_ON_BLACKBOARD( MESSAGE_ADDR_TYPE MESSAGE_ADDR, MESSAGE_SIZE_TYPE LENGTH,RETURN_CODE_TYPE *RETURN_CODE);
		void READ_FROM_BLACKBOARD(MESSAGE_ADDR_TYPE MESSAGE_ADDR, MESSAGE_SIZE_TYPE* LENGTH,RETURN_CODE_TYPE *RETURN_CODE);
	public:
