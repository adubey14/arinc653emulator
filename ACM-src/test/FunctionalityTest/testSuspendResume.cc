...
int main(){
	...
	LOGGER( USER,"Testapp Started. The clock_realtime resolution is %ld sec and %ld nanoseconds",res.tv_sec,res.tv_nsec);
	RETURN_CODE_TYPE RETURN_CODE;
	...
	APERIODIC_PROCESS_ID2 = APEX_HELPER_CREATE_PROCESS(INFINITE_TIME_VALUE, //SYSTEM_TIME_TYPE PERIOD,
		INFINITE_TIME_VALUE, //SYSTEM_TIME_TYPE TIME_CAPACITY,
