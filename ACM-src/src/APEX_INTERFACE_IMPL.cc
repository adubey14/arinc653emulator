...
namespace ACM_USER {
	...
	*/
	...
	{
		PROCESS_ID_TYPE DUMMY_PROCESS_ID= APEX_HELPER_CREATE_PROCESS(INFINITE_TIME_VALUE, //SYSTEM_TIME_TYPE PERIOD,
                           INFINITE_TIME_VALUE, //SYSTEM_TIME_TYPE TIME_CAPACITY,
						   (SYSTEM_ADDRESS_TYPE)DUMMY::DUMMY_PROCESS_1234, //SYSTEM_ADDRESS_TYPE ENTRY_POINT,
	...
	PROCESS_ID_TYPE APEX_HELPER_CREATE_PROCESS(SYSTEM_TIME_TYPE PERIOD, SYSTEM_TIME_TYPE TIME_CAPACITY,	SYSTEM_ADDRESS_TYPE ENTRY_POINT,STACK_SIZE_TYPE STACK_SIZE,PRIORITY_TYPE BASE_PRIORITY,DEADLINE_TYPE DEADLINE,std::string PROCESS_NAME,RETURN_CODE_TYPE *RETURN_CODE)
	{
		...
		if(PROCESS_NAME.size()>MAX_NAME_LENGTH)
		{
		   LOGGER(WARNING,"length of name %s is greater than %d. Truncating",PROCESS_NAME.c_str(),MAX_NAME_LENGTH);
		}
		strncpy(attr.NAME,PROCESS_NAME.c_str(),MAX_NAME_LENGTH);
		ACM_INTERNAL::APEX::CREATE_PROCESS(&attr,&NEW_PROCESS_ID,RETURN_CODE); //RETURN_CODE Is already an address
		return NEW_PROCESS_ID;
	}	



	void APEX_HELPER_START_PROCESS(PROCESS_NAME_TYPE PNAME,RETURN_CODE_TYPE *RETURN_CODE)
	{
		PROCESS_ID_TYPE NEW_PROCESS_ID;
		ACM_INTERNAL::APEX::GET_PROCESS_ID(PNAME,&NEW_PROCESS_ID,RETURN_CODE);
		if(*RETURN_CODE != NO_ERROR){
			LOGGER( ERROR, "APEX_HELPER_START_PROCESS: GET_PROCESS_ID return code for PROCESS_NAME %s is %d",PNAME, *RETURN_CODE );
			return;
		}
		...
		/*!out*/RETURN_CODE_TYPE *RETURN_CODE)
	{
		...
		ACM_INTERNAL::APEX::GET_PROCESS_STATUS (
			...
			/*!out*/ RETURN_CODE );
		if(*RETURN_CODE != NO_ERROR){
			LOGGER( ERROR, "APEX_HELPER_START_PROCESS: GET_PROCESS_STATUS return code for PROCESS_NAME %s is %d",PNAME, *RETURN_CODE );
			*PROCESS_RESPONSE_LENGTH=0;
			return;
		}
		...
		if(*RETURN_CODE != NO_ERROR){
			LOGGER( ERROR, "APEX_HELPER_START_PROCESS:: START return code for PROCESS_NAME %s is %d",PNAME, *RETURN_CODE );
			*PROCESS_RESPONSE_LENGTH=0;
			return;
		}
		...
		if(!isAperiodic)
		{
			LOGGER( WARNING, "APEX_HELPER_START_PROCESS::Started. But Cannot blck for a periodic process",PNAME);
	...
	void APEX_HELPER_DELAYED_START_PROCESS(PROCESS_NAME_TYPE PNAME,SYSTEM_TIME_TYPE DELAY, RETURN_CODE_TYPE *RETURN_CODE)
	{
		PROCESS_ID_TYPE NEW_PROCESS_ID;
		ACM_INTERNAL::APEX::GET_PROCESS_ID(PNAME,&NEW_PROCESS_ID,RETURN_CODE);
		if(*RETURN_CODE != NO_ERROR){
			LOGGER( ERROR, "APEX_HELPER_DELAYED_START_PROCESS: GET_PROCESS_ID return code for PROCESS_NAME %s is %d",PNAME, *RETURN_CODE );
			return;
		}
	...
	void APEX_HELPER_STOP_PROCESS(PROCESS_NAME_TYPE PNAME,RETURN_CODE_TYPE *RETURN_CODE)
	{
		PROCESS_ID_TYPE NEW_PROCESS_ID;
		ACM_INTERNAL::APEX::GET_PROCESS_ID(PNAME,&NEW_PROCESS_ID,RETURN_CODE);
		if(*RETURN_CODE != NO_ERROR){
			LOGGER( ERROR, "APEX_HELPER_STOP_PROCESS: GET_PROCESS_ID return code for PROCESS_NAME %s is %d",PNAME, *RETURN_CODE );
			return;
		}
	...
	void APEX_HELPER_SUSPEND_PROCESS(PROCESS_NAME_TYPE PNAME,RETURN_CODE_TYPE *RETURN_CODE)
	{
		PROCESS_ID_TYPE NEW_PROCESS_ID;
		ACM_INTERNAL::APEX::GET_PROCESS_ID(PNAME,&NEW_PROCESS_ID,RETURN_CODE);
		if(*RETURN_CODE != NO_ERROR){
			LOGGER( ERROR, "APEX_HELPER_SUSPEND_PROCESS: GET_PROCESS_ID return code for PROCESS_NAME %s is %d",PNAME, *RETURN_CODE );
			return;
		}
		ACM_INTERNAL::APEX::SUSPEND(NEW_PROCESS_ID,RETURN_CODE);
		return;
	}
	void APEX_HELPER_RESUME_PROCESS(PROCESS_NAME_TYPE PNAME,RETURN_CODE_TYPE *RETURN_CODE)
	{
		PROCESS_ID_TYPE NEW_PROCESS_ID;
		ACM_INTERNAL::APEX::GET_PROCESS_ID(PNAME,&NEW_PROCESS_ID,RETURN_CODE);
		if(*RETURN_CODE != NO_ERROR){
			LOGGER( ERROR, "APEX_HELPER_RESUME_PROCESS: GET_PROCESS_ID return code for PROCESS_NAME %s is %d",PNAME, *RETURN_CODE );
			return;
		}
	...
	void APEX_HELPER_SET_EVENT(EVENT_NAME_TYPE EVENT_NAME,RETURN_CODE_TYPE *RETURN_CODE)
	{
		...
		if(*RETURN_CODE==NO_ERROR){
			...
			//LOGGER( WARNING, "APEX_HELPER_SET_EVENT return code for event_name %s is %d",EVENT_NAME, *RETURN_CODE );

			return;
		}
	}

	void APEX_HELPER_RESET_EVENT(EVENT_NAME_TYPE EVENT_NAME,RETURN_CODE_TYPE *RETURN_CODE)
	{
		//LOGGER("FINDING EVENT");
		EVENT_ID_TYPE EVENT_ID;
		ACM_INTERNAL::APEX::GET_EVENT_ID(EVENT_NAME,&EVENT_ID,RETURN_CODE);
		if(*RETURN_CODE==NO_ERROR){
			...
			//LOGGER( WARNING, "APEX_HELPER_RESET_EVENT return code for event_name %s is %d",EVENT_NAME, *RETURN_CODE );
	...
	void  APEX_HELPER_WAIT_EVENT (EVENT_NAME_TYPE EVENT_NAME, SYSTEM_TIME_TYPE TIME_OUT,RETURN_CODE_TYPE *RETURN_CODE )		
	{
		EVENT_ID_TYPE EVENT_ID;
		ACM_INTERNAL::APEX::GET_EVENT_ID(EVENT_NAME,&EVENT_ID,RETURN_CODE);
		if(*RETURN_CODE==NO_ERROR){
			...
			//LOGGER( WARNING, "APEX_HELPER_WAIT_EVENT return code for event_name %s is %d",EVENT_NAME, *RETURN_CODE );
			return;
		}
		return;
	}
	...
	void CREATE_SEMAPHORE (
		...
		/*!out*/ RETURN_CODE_TYPE *RETURN_CODE ){
			...
			ACM_INTERNAL::APEX::CREATE_SEMAPHORE (SEMAPHORE_NAME, CURRENT_VALUE, MAXIMUM_VALUE, QUEUING_DISCIPLINE, SEMAPHORE_ID, RETURN_CODE );
	}
	...
	void GET_SEMAPHORE_ID (
		...
		/*!out*/ RETURN_CODE_TYPE *RETURN_CODE ){
			...
			ACM_INTERNAL::APEX::GET_SEMAPHORE_ID(SEMAPHORE_NAME,SEMAPHORE_ID,RETURN_CODE);
	...
	void GET_SEMAPHORE_STATUS (
		...
		/*!out*/ RETURN_CODE_TYPE *RETURN_CODE ){
			ACM_INTERNAL::APEX::GET_SEMAPHORE_STATUS(SEMAPHORE_ID,SEMAPHORE_STATUS,RETURN_CODE);
	}
	...
	void GET_PROCESS_STATUS (
		...
		/*!out*/ RETURN_CODE_TYPE *RETURN_CODE ){
			ACM_INTERNAL::APEX::GET_PROCESS_STATUS (PROCESS_ID,PROCESS_STATUS,RETURN_CODE );
	...
	void CREATE_BLACKBOARD (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE ){
			...
			ACM_INTERNAL::APEX::CREATE_BLACKBOARD(BLACKBOARD_NAME,MAX_MESSAGE_SIZE,BLACKBOARD_ID,RETURN_CODE);
	}
	void DISPLAY_BLACKBOARD (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::DISPLAY_BLACKBOARD(BLACKBOARD_ID,MESSAGE_ADDR,LENGTH,RETURN_CODE);
	}
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		...
		ACM_INTERNAL::APEX::READ_BLACKBOARD(BLACKBOARD_ID,TIME_OUT,MESSAGE_ADDR,LENGTH,RETURN_CODE);
	}
	...
	void GET_BLACKBOARD_ID (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE ){
			...
			ACM_INTERNAL::APEX::GET_BLACKBOARD_ID(BLACKBOARD_NAME,BLACKBOARD_ID,RETURN_CODE);
	...
	void GET_BLACKBOARD_STATUS (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::GET_BLACKBOARD_STATUS ( BLACKBOARD_ID, BLACKBOARD_STATUS, RETURN_CODE );
	...
	*/
	void CREATE_SAMPLING_PORT (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::CREATE_SAMPLING_PORT(SAMPLING_PORT_NAME,MAX_MESSAGE_SIZE,PORT_DIRECTION,REFRESH_PERIOD,SAMPLING_PORT_ID,RETURN_CODE);
	}
	void WRITE_SAMPLING_MESSAGE (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )	
	{
		ACM_INTERNAL::APEX::WRITE_SAMPLING_MESSAGE ( SAMPLING_PORT_ID, MESSAGE_ADDR, LENGTH,RETURN_CODE );
	}
	void READ_SAMPLING_MESSAGE (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::READ_SAMPLING_MESSAGE ( SAMPLING_PORT_ID, MESSAGE_ADDR,LENGTH,VALIDITY,RETURN_CODE );
	}
	void GET_SAMPLING_PORT_ID (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::GET_SAMPLING_PORT_ID(SAMPLING_PORT_NAME,SAMPLING_PORT_ID,RETURN_CODE);
	}
	void GET_SAMPLING_PORT_STATUS (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::GET_SAMPLING_PORT_STATUS(SAMPLING_PORT_ID,SAMPLING_PORT_STATUS,RETURN_CODE);
	}

	void READ_CONTENTS_TO_DATA_BUFFER(SAMPLING_PORT_ID_TYPE SAMPLING_PORT_ID,MESSAGE_ADDR_TYPE msg_ptr,MESSAGE_SIZE_TYPE  MAX_LENGTH,MESSAGE_SIZE_TYPE*  READ_LENGTH,RETURN_CODE_TYPE* RETURN_CODE)
	{
		ACM_INTERNAL::APEX::READ_CONTENTS_TO_DATA_BUFFER( SAMPLING_PORT_ID,msg_ptr,  MAX_LENGTH, READ_LENGTH, RETURN_CODE);
	}
	void WRITE_CONTENTS_FROM_DATA_BUFFER(SAMPLING_PORT_ID_TYPE SAMPLING_PORT_ID,MESSAGE_ADDR_TYPE msg_ptr,MESSAGE_SIZE_TYPE  LENGTH,RETURN_CODE_TYPE* RETURN_CODE)
	{
		ACM_INTERNAL::APEX::WRITE_CONTENTS_FROM_DATA_BUFFER( SAMPLING_PORT_ID, msg_ptr,  LENGTH, RETURN_CODE);
	}
	...
	*/
	void CREATE_QUEUING_PORT (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX:: CREATE_QUEUING_PORT (QUEUING_PORT_NAME,MAX_MESSAGE_SIZE,MAX_NB_MESSAGE,PORT_DIRECTION,QUEUING_DISCIPLINE,QUEUING_PORT_ID,RETURN_CODE );
	}
	void SEND_QUEUING_MESSAGE (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE)
	{
		ACM_INTERNAL::APEX::SEND_QUEUING_MESSAGE (QUEUING_PORT_ID,MESSAGE_ADDR, LENGTH,TIME_OUT,RETURN_CODE);
	}

	void MESSAGE_QUEUE_SEND_MESSAGE_FROM_BUFFER(QUEUING_PORT_ID_TYPE QUEUING_PORT_ID,
		MESSAGE_ADDR_TYPE msg_ptr,MESSAGE_SIZE_TYPE LENGTH, SYSTEM_TIME_TYPE TIME_OUT,RETURN_CODE_TYPE* RETURN_CODE)

	{
		ACM_INTERNAL::APEX::MESSAGE_QUEUE_SEND_MESSAGE_FROM_BUFFER (QUEUING_PORT_ID,msg_ptr, LENGTH,TIME_OUT,RETURN_CODE);
	}
	void RECEIVE_QUEUING_MESSAGE (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::RECEIVE_QUEUING_MESSAGE (QUEUING_PORT_ID,TIME_OUT,MESSAGE_ADDR,LENGTH,RETURN_CODE );
	}
	void GET_QUEUING_PORT_ID (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::GET_QUEUING_PORT_ID (QUEUING_PORT_NAME,QUEUING_PORT_ID,RETURN_CODE );
	}
	void GET_QUEUING_PORT_STATUS (
		...
		/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::GET_QUEUING_PORT_STATUS (QUEUING_PORT_ID,QUEUING_PORT_STATUS,RETURN_CODE );
	}
	...
	{
		ACM_INTERNAL::APEX::CREATE_BUFFER (BUFFER_NAME, MAX_MESSAGE_SIZE,MAX_NB_MESSAGE, QUEUING_DISCIPLINE,BUFFER_ID, RETURN_CODE );

	}
	void SEND_BUFFER (/*in */ BUFFER_ID_TYPE BUFFER_ID,	/*in */ MESSAGE_ADDR_TYPE MESSAGE_ADDR, /* by reference */	/*in */ MESSAGE_SIZE_TYPE LENGTH,	/*in */ SYSTEM_TIME_TYPE TIME_OUT,	/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::SEND_BUFFER (/*in */ BUFFER_ID,	/*in */ MESSAGE_ADDR, /* by reference */	/*in */  LENGTH,	/*in */  TIME_OUT,	/*out*/ RETURN_CODE );
	}
	...
	{
		ACM_INTERNAL::APEX::RECEIVE_BUFFER (/*in */ BUFFER_ID,/*in */  TIME_OUT,/*out*/  MESSAGE_ADDR,	/*out*/ LENGTH,/*out*/ RETURN_CODE );
	}
	void GET_BUFFER_ID (/*in */ BUFFER_NAME_TYPE BUFFER_NAME,/*out*/ BUFFER_ID_TYPE *BUFFER_ID,/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::GET_BUFFER_ID (/*in */  BUFFER_NAME,/*out*/ BUFFER_ID,/*out*/ RETURN_CODE );
	}
	void GET_BUFFER_STATUS (/*in */ BUFFER_ID_TYPE BUFFER_ID,/*out*/ BUFFER_STATUS_TYPE *BUFFER_STATUS,	/*out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::GET_BUFFER_STATUS (/*in */  BUFFER_ID,/*out*/ BUFFER_STATUS,	/*out*/ RETURN_CODE );
	}
	...
	void REGISTER_PROCESS_WITH_HEALTH_MANAGER(PROCESS_ID_TYPE PROCESS_ID,HM_DESCRIPTOR_ID_TYPE HM_DESCRIPTOR_ID,BLACKBOARD_ID_TYPE *BLACKBOARD_ID, /*out*/ RETURN_CODE_TYPE *RETURN_CODE)
	{
		ACM_INTERNAL::APEX::REGISTER_PROCESS_WITH_HEALTH_MANAGER( PROCESS_ID, HM_DESCRIPTOR_ID, BLACKBOARD_ID, /*out*/ RETURN_CODE);
	}
	...
	{
		ACM_INTERNAL::APEX::HM_GET_MY_BUFFER_ID(/*OUT*/BUFFER_ID,/*out*/RETURN_CODE);
	}
	...
	{
		ACM_INTERNAL::APEX::RAISE_APPLICATION_ERROR (/*!in */  ERROR_CODE,/*!in */  MESSAGE_ADDR,/*!in */  LENGTH,/*!out*/ RETURN_CODE );
	...
	{
		ACM_INTERNAL::APEX::HM_GET_PROCESS_ERROR_MESSAGE( ERROR_STATUS, TARGET_BBOARD_ID,RETURN_CODE);
	}
	...
	void RAISE_APPLICATION_ERROR_AND_GET_RESPONSE (	/*!in */ ERROR_CODE_TYPE ERROR_CODE,
			...
			/*!out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		ACM_INTERNAL::APEX::RAISE_APPLICATION_ERROR_AND_GET_RESPONSE (	/*!in */ ERROR_CODE,
			/*!in */  MESSAGE_ADDR,
			/*!in */  LENGTH,
			/*!in */  TIME_OUT, //Added Timeout in response to the discussion with Gabor
			/*!out*/ HM_RESPONSE,
			/*!out*/ RETURN_CODE );
	}
		...
		/*!out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		...
		ACM_INTERNAL::APEX::CREATE_RW_SEMAPHORE(SEMAPHORE_NAME,MAXIMUM_READERS,SEMAPHORE_ID,RETURN_CODE);
	}
		...
		/*!out*/ RETURN_CODE_TYPE *RETURN_CODE )
	{
		...
		ACM_INTERNAL::APEX::GET_RW_SEMAPHORE_ID(SEMAPHORE_NAME,SEMAPHORE_ID,RETURN_CODE);
	}
