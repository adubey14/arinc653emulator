...
void PROCESS_MAIN(void) {
  ...
  // Tests that no error is returned when correctly starting an aperiodic
  // process
  ...
  // Tests that the correct code is returned when the delay time is greater than
  // the periodic process's period
...
int main() {
  ...
  PROCESS_PERIODIC_ATTR.BASE_PRIORITY =
      91; // This priority should be more than the aperiodic priority. Since we
