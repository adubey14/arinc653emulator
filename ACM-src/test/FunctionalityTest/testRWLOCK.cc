/*
This file tests the use of read write locks. This locks are an extension to the
ARINC-653 API.
*/
...
void testperiodic(void) {
  ...
  LOGGER(APP, "From testperiodic: Finished Work in test Periodic method. "
              "Return code is %d",
         RETURN_CODE);
}
void anotherperiodic(void) {
  ...
  LOGGER(APP, "anotherperiodic:  Finished Work in anotherperiodic:The return "
              "code is %d",
         RETURN_CODE);
}
