...
void anotherperiodic(void)
{
	...
	if(LENGTH >0){
					//std::cout<<"Received Response. Processing Done="<<response.PROCESSING_COMPLETED<<std::endl;
...
if(argc !=2)
{
std::cout<<"Usage "<<argv[0]<<" [cpuNumber in integer e.g. 0 1 or 2 ...]" <<std::endl;
return -1;
}
int cpunumber;
...
{
std::cout<<"You gave wrong choice:"<<argv[1]<<":It should be an integer"<<std::endl;
return -1;
}
...
APERIODIC_ID = APEX_HELPER_CREATE_PROCESS(INFINITE_TIME_VALUE, //SYSTEM_TIME_TYPE PERIOD,
