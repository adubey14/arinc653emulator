...
AbstractSocket::AbstractSocket(int sockDesc) { this->sockDesc = sockDesc; }
...
void AbstractSocket::setLocalPort(unsigned short localPort) throw(
    SocketException) {
...
void AbstractSocket::setLocalAddressAndPort(
...
void UDPSocket::setReuse() {
  int yes = 1;
  setsockopt(sockDesc, SOL_SOCKET, SO_REUSEADDR, (raw_type *)&yes, sizeof(yes));
}
