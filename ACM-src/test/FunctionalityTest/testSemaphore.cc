/*
This file tests the use of semaphore interfaces and shows the use of print created object list.
*/
...
int main(){
	...
	PERIODIC_ID = APEX_HELPER_CREATE_PROCESS(convertSecsToNano(2), //SYSTEM_TIME_TYPE PERIOD,
	...
	PERIODIC_ID2 = APEX_HELPER_CREATE_PROCESS(convertSecsToNano(4), //SYSTEM_TIME_TYPE PERIOD,
	...
	LOGGER(APP,"OUT OF WAIT. Return Code is %s ",RETURN_CODE_TO_STRING(RETURN_CODE));
